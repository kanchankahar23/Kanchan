    ...
    <nav className="bg-[#041122] text-white px-10 py-4 shadow-md">
      <div className="flex justify-between items-center">
        ...
        <ul className="hidden md:flex gap-12 text-lg">
          ...
          <li className="hover:text-[#E6F99D] font-bold transition-all duration-300 cursor-pointer">Home</li>
          <li className="hover:text-[#E6F99D] font-bold transition-all duration-300 cursor-pointer">About Me</li>
          <li className="hover:text-[#E6F99D] font-bold transition-all duration-300 cursor-pointer">Skills</li>
          <li className="hover:text-[#E6F99D] font-bold transition-all duration-300 cursor-pointer">Projects</li>
        </ul>
